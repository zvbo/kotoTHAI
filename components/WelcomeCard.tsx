...
export default function WelcomeCard({ remainingTime, onDismiss }: WelcomeCardProps) {
  return (
    <View pointerEvents="box-none" style={styles.overlay}>
      ...
      >
        <Text style={styles.title}>欢迎使用 KotoTHAI</Text>
        <Text style={styles.emoji}>泰 · 中 · 英</Text>
        ...
        <Text style={styles.description}>
          KotoTHAI 是您的极简主义 AI 旅行口译员，提供泰语｜中文｜英语三语实时同声传译。开启实时模式后，应用会自动聆听并进行双向翻译，无需手动开始/停止。
        </Text>
